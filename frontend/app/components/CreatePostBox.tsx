...
export default function CreatePostBox({ onPost }: CreatePostBoxProps) {
  ...
  const submit = () => {
    ...
    onPost(content, visibility, selectedImage || undefined);
    setContent("");
  ...
  return (
    <div className="_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16">
      ...
      {/* Image Preview */}
      {imagePreview && (
        <div style={{ margin: "12px 0", position: "relative", display: "inline-block" }}>
      ...
      <div className="_feed_inner_text_area_bottom">
        ...
        <div className="_feed_inner_text_area_item" style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <select
            className="_feed_inner_text_area_bottom_photo_link"
            style={{ padding: "8px", border: "1px solid #ccc", borderRadius: "5px", fontSize: "13px" }}
            value={visibility}
