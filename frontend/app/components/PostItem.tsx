        ...
        <div className="_feed_inner_timeline_total_reacts_image">
          {post.likes > 0 && (
            <>
              ...
              {post.likes > 1 && <img src="/assets/images/react_img2.png" alt="Image" className="_react_img" />}
              {post.likes > 2 && <img src="/assets/images/react_img3.png" alt="Image" className="_react_img _rect_img_mbl_none" />}
            </>
          )}
          <p className="_feed_inner_timeline_total_reacts_para">{post.likes > 0 ? post.likes : ""}</p>
        </div>
